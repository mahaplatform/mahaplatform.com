  ...
  records: [
    {
      ...
      body: '<html><body><p>Hello <%= first_name %>,</p><p>A new account has been created for you. All we need to do is make sure this is a valid email address.</p><p><a href="<%= activation_url %>">Activate Account</a></p></body></html>'
    }, {
      team_id: 1,
      code: 'reset',
      name: 'Reset Password',
