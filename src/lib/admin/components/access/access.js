...
class Access extends React.Component {
  ...
  componentDidMount() {
    const { endpoint, onFetchUnassigned, onFetchAssigned } = this.props
    onFetchUnassigned()
    onFetchAssigned(endpoint)
  }
  ...
  _handleSave() {
    const { action, assigned, onSave } = this.props
