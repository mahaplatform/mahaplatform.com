...
import dashboardCard0 from '../../apps/events/admin/dashboard/ticket_type_totals/index.js'
import dashboardCard1 from '../../apps/maha/admin/dashboard/greeting/index.js'
