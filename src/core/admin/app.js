...
import adminattachments from '../../admin/components/attachments'
import adminattachmentsWeb from '../../admin/components/attachments/web'
import adminauthorized from '../../admin/components/authorized'
import admincarousel from '../../admin/components/carousel'
import adminchooser from '../../admin/components/chooser'
import admincollectionFilters from '../../admin/components/collection/filters'
import admincollection from '../../admin/components/collection'
...
import adminfields from '../../admin/components/fields'
import adminformAddressfield from '../../admin/components/form/addressfield'
import adminformAssignmentfield from '../../admin/components/form/assignmentfield'
import adminformAttachmentfield from '../../admin/components/form/attachmentfield'
import adminformColorfield from '../../admin/components/form/colorfield'
import adminformCriteriafield from '../../admin/components/form/criteriafield'
import adminformFilefield from '../../admin/components/form/filefield'
import adminformHtmlfield from '../../admin/components/form/htmlfield'
import adminformLinkfield from '../../admin/components/form/linkfield'
import adminformLookup from '../../admin/components/form/lookup'
import adminformLookup2 from '../../admin/components/form/lookup2'
import adminformPhonenumberfield from '../../admin/components/form/phonenumberfield'
import adminformProfilefield from '../../admin/components/form/profilefield'
import adminform from '../../admin/components/form'
import adminformSelectCheckboxes from '../../admin/components/form/select/checkboxes'
import adminformSelectRadioGroup from '../../admin/components/form/select/radio_group'
import adminformSelect from '../../admin/components/form/select'
import adminformTablefield from '../../admin/components/form/tablefield'
import adminformToggleList from '../../admin/components/form/toggle_list'
import adminformVideofield from '../../admin/components/form/videofield'
import adminimageEditor from '../../admin/components/image_editor'
import adminimportConfigure from '../../admin/components/import/configure'
import adminimportField from '../../admin/components/import/field'
import adminimportFinalizing from '../../admin/components/import/finalizing'
import adminimportIntro from '../../admin/components/import/intro'
import adminimportMapping from '../../admin/components/import/mapping'
import adminimportParsing from '../../admin/components/import/parsing'
import adminimportPreview from '../../admin/components/import/preview'
import adminimportProcessing from '../../admin/components/import/processing'
import adminimport from '../../admin/components/import'
import adminimportUpload from '../../admin/components/import/upload'
import adminimportValidatingFix from '../../admin/components/import/validating/fix'
import adminimportValidating from '../../admin/components/import/validating'
...
import adminpreview from '../../admin/components/preview'
import adminprompt from '../../admin/components/prompt'
import adminsearch from '../../admin/components/search'
