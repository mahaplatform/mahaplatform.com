...
import dashboardCard0 from '../../apps/crm/admin/dashboard/email_campaign/index.js'
...
import dashboardCard3 from '../../apps/events/admin/dashboard/ticket_type_totals/index.js'
...
class App extends React.Component {
  ...
  _getDashboardCards() {
    return [
      ...
      },
      {
        ...
        code: 'events:'+dashboardCard3.code
      },
      {
        ...dashboardCard4,
        app: 'maha',
  ...
  _getRoutes() {
    return [
      ...
      { path: '/admin/events', children: eventsRoutes },
