...
union
    ...
    await knex.raw(`
      ...
      when (finance_line_items.discount_percent is not null) then (((finance_line_items.quantity)::numeric * finance_line_items.price) * finance_line_items.discount_percent)
      else 0.00
      end as discount
      from (finance_invoices
