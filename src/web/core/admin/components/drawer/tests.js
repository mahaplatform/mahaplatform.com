...
describe('drawer component', () => {
  ...
  describe('component', () => {
    ...
    it('renders with a default state', () => {
      ...
      expect(drawer.is('div.maha-drawer')).to.be.true

      const child = drawer.childAt(0)
      expect(child.is('div.foo')).to.be.true

      const overlay = drawer.childAt(1).childAt(0)
      expect(overlay.is('div.maha-drawer-overlay')).to.be.true

      const panel = drawer.childAt(2).childAt(0)
      expect(panel.is('div.maha-drawer-panel.maha-drawer-panel-right')).to.be.true
