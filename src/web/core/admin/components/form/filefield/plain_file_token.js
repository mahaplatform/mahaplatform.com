...
class PlainFileToken extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={`maha-filefield-file-preview ${this._getExt(file_name)}`}>
        <div className="maha-filefield-file-preview-icon">
          <i className={`fa fa-fw fa-${this._getIcon(file_name)}`} />
        </div>
        <div className="maha-filefield-file-preview-details">
          <div className="maha-filefield-file-preview-filename">
            { file_name }
          </div>
          <div className="maha-filefield-file-preview-filesize">
            { bytes(file_size) }
          </div>
        </div>
      </div>
