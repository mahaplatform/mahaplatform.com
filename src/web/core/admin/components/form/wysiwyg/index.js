    ...
    return (
      <div className="maha-wysiwyg">
        <div className="maha-wysiwyg-header">
          ...
          <div className="maha-wysiwyg-header-section">
            <div className="maha-wysiwyg-header-icon" onClick={ this._handleBeginLink.bind(this) }>
        ...
        <CSSTransition in={ linking } classNames="expanded" timeout={ 150 } mountOnEnter={ true } unmountOnExit={ true }>
          <div className="maha-wysiwyg-input">
            <div className="maha-wysiwyg-input-element">
              <input { ...this._getLinkInput()}/>
            </div>
            <div className="maha-wysiwyg-input-icon" onClick={ this._handleEndLink.bind(this) }>
              <i className="fa fa-times" />
            </div>
          </div>
        </CSSTransition>
        <CSSTransition in={ linking } classNames="expanded" timeout={ 150 } mountOnEnter={ true } unmountOnExit={ true }>
          <div className="maha-wysiwyg-overlay" onClick={ this._handleEndLink.bind(this) } />
        </CSSTransition>
