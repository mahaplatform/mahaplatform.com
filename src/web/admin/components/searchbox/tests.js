...
describe('searchbox component', () => {
  ...
  describe('component', () => {
    ...
    it('renders with a default state', () => {
      ...
      expect(searchbox.is('div.maha-searchbox')).to.be.true
      expect(searchbox.children().length).to.equal(2)

      const searchboxSearchIconWrapper = searchbox.childAt(0)
      expect(searchboxSearchIconWrapper.is('div.maha-searchbox-icon')).to.be.true
      ...
      expect(searchboxInputWrapper.is('div.maha-searchbox-input')).to.be.true
    ...
    it('renders with a remove icon', () => {
      ...
      expect(searchboxRemoveIconWrapper.is('div.maha-searchbox-icon')).to.be.true
