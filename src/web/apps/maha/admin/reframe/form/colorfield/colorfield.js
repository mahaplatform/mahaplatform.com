...
class ColorField extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="maha-colorfield" tabIndex={ tabIndex }>
        { colors.map((color, index) => (
          <div key={`color_${index}`} className="maha-color" style={{ backgroundColor: color.value }} onClick={ this._handleSet.bind(this, color.name) }>
