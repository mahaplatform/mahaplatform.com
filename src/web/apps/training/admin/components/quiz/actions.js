export const fetch = (quiz_id) => ({
  type: 'API_REQUEST',
  method: 'GET',
  endpoint: `/api/admin/training/quizes/${quiz_id}/administrations`,
...
export const question = (quiz_id) => ({
  type: 'API_REQUEST',
  method: 'GET',
  endpoint: `/api/admin/training/quizes/${quiz_id}/administrations/question`,
...
export const answer = (quiz_id, answer_id) => ({
  type: 'API_REQUEST',
  method: 'POST',
  endpoint: `/api/admin/training/quizes/${quiz_id}/administrations/answer`,
  body: { answer_id },
