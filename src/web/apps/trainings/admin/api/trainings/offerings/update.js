...
const updateRoute = async (req, res) => {
  ...
  await socket.refresh(req, [
    `/admin/trainings/trainings/${req.params.training_id}`,
    `/admin/trainings/trainings/${req.params.training_id}/offerings`,
    `/admin/trainings/trainings/${req.params.training_id}/offerings/${offering.get('id')}`
  ])
