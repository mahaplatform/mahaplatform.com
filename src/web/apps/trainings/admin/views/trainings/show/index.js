...
const mapResourcesToPage = (props, context) => ({
  training: `/api/admin/trainings/trainings/${props.params.id}`,
  lessons: `/api/admin/trainings/trainings/${props.params.id}/lessons`,
  materials: `/api/admin/trainings/trainings/${props.params.id}/materials`,
  quizes: `/api/admin/trainings/trainings/${props.params.id}/quizes`,
  offerings: `/api/admin/trainings/trainings/${props.params.id}/offerings`
})
