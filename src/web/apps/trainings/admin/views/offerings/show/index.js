...
const mapResourcesToPage = (props, context) => ({
  offering: `/api/admin/trainings/trainings/${props.params.training_id}/offerings/${props.params.id}`,
  assignments: `/api/admin/trainings/trainings/${props.params.training_id}/offerings/${props.params.id}/assignments`
})
