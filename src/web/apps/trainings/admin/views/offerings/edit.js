...
class Edit extends React.Component {
  ...
  _getForm() {
    ...
    return {
      title: 'Edit Offering',
      method: 'patch',
      endpoint: `/api/admin/trainings/trainings/${offering.training.id}/offerings/${offering.id}/edit`,
      action: `/api/admin/trainings/trainings/${offering.training.id}/offerings/${offering.id}`,
