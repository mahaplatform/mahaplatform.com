...
class Registration extends React.Component {
  ...
  _getForm() {
    ...
    return {
      title: 'Registration',
      method: 'patch',
      endpoint: `/api/admin/trainings/assignments/${assignment.id}/edit`,
      action: `/api/admin/trainings/assignments/${assignment.id}`,
      onCancel: this._handleCancel,
      onSuccess: this._handleSuccess,
      sections: [
        {
          fields: [
            { name: 'offering_id', type: 'radiogroup', prompt: 'Choose a training', endpoint: `/api/admin/trainings/trainings/${assignment.training.id}/offerings`, value: 'id', text: 'title', format: OfferingToken }
          ]
        }
      ]
    }
