...
const showRoute = async (req, res) => {
  ...
  const expense = await Expense.scope({
    ...
    withRelated: ['receipts.asset','receipts.asset.source','user','project.members','line_items.project','line_items.expense_type','status','vendor','account','audit.story','audit.user.photo'],
    transacting: req.trx
  })
