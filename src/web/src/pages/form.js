    ...
    <Fragment>
      <Head>
        ...
        { form.config.seo.image &&
          <Fragment>
            <meta property="og:image" content={`${process.env.ADMIN_HOST}/imagecache/fit=cover&w=1200&h=630&q=100${form.config.seo.image}`} />
            <meta property="og:secure_url" content={`${process.env.ADMIN_HOST}/imagecache/fit=cover&w=1200&h=630&q=100${form.config.seo.image}`} />
