...
describe('tabs component', () => {
  ...
  describe('component', () => {
    ...
    it('renders with a default state', () => {
      ...
      expect(tabs.is('div.maha-tabs')).to.be.true

      const header = tabs.childAt(0)
      expect(header.is('div.maha-tabs-header')).to.be.true

      const items = header.childAt(0)
      expect(items.is('div.maha-tabs-items')).to.be.true

      const body = tabs.childAt(1)
      expect(body.is('div.maha-tabs-body')).to.be.true
    ...
    it('renders with header content', () => {
      ...
      expect(headerContentWrapper.is('div.maha-tabs-header-content')).to.be.true
    ...
    it('renders with items', () => {
      ...
      expect(headerItemsWrapper.is('div.maha-tabs-items')).to.be.true
      expect(headerItemsWrapper.children().length).to.equal(2)

      const headerItem1 = headerItemsWrapper.childAt(0)
      expect(headerItem1.is('div.maha-tabs-item')).to.be.true

      const headerItem2 = headerItemsWrapper.childAt(1)
      expect(headerItem2.is('div.maha-tabs-item')).to.be.true

      const tabsWrapper = tabs.childAt(1)
      expect(tabsWrapper.is('div.maha-tabs-body')).to.be.true
      expect(tabsWrapper.children().length).to.equal(2)

      const tab1 = tabsWrapper.childAt(0)
      expect(tab1.is('div.maha-tab')).to.be.true

      const tab2 = tabsWrapper.childAt(0)
      expect(tab2.is('div.maha-tab')).to.be.true
