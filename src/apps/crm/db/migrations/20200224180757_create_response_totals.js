const CreateResponseTotals = {
  ...
  up: async (knex) => {
    ...
    await knex.raw(`
      ...
      from crm_responses
      inner join finance_invoice_payments on finance_invoice_payments.invoice_id=crm_responses.invoice_id
    `)
...
export default CreateResponseTotals
