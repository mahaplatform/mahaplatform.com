const UpdateCrmRecipients = {
  ...
  up: async (knex) => {
    ...
    await knex.raw(`
    create or replace view crm_recipients as
    select
    'email' as type,
    ...
    inner join crm_consents on crm_consents.phone_number_id = crm_phone_numbers.id and crm_consents.type='sms'
    union
    select
    'sms' as type,
    'transactional' as purpose,
    ...
    from crm_phone_numbers
    inner join crm_contacts on crm_contacts.id = crm_phone_numbers.contact_id
    inner join crm_consents on crm_consents.phone_number_id = crm_phone_numbers.id and crm_consents.type='voice'
    union
    select
    'voice' as type,
    'transactional' as purpose,
    ...
    inner join crm_consents on crm_consents.mailing_address_id = crm_mailing_addresses.id and crm_consents.type='mail'
    union
    select
    'mail' as type,
    'transactional' as purpose,
...
export default UpdateCrmRecipients
