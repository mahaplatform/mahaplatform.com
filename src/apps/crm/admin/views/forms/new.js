      ...
      sections: [
        {
          ...
          fields: [
            { label: 'Template', name: 'template_id', type: 'lookup', placeholder: 'Choose a template', disabled: program_id === null, endpoint: `/api/admin/crm/programs/${program_id}/templates`, value: 'id', text: 'title', required: true },
