const appraisalSerializer = (req, result) => ({
  ...
  employee_position_description_updated: result.get('employee_position_description_updated'),
  employee_position_description_comments: result.get('employee_position_description_comments'),
  ...
  supervisor_position_description_updated: result.get('supervisor_position_description_updated'),
  supervisor_position_description_comments: result.get('supervisor_position_description_comments'),
  ...
  employee_signature: result.get('employee_signature'),
  employee_signed_at: result.get('employee_signed_at'),
  supervisor_signature: result.get('supervisor_signature'),
  supervisor_signed_at: result.get('supervisor_signed_at'),
  issue_leader_signature: result.get('issue_leader_signature'),
  issue_leader_signed_at: result.get('issue_leader_signed_at'),
  executive_director_signature: result.get('executive_director_signature'),
  executive_director_signed_at: result.get('executive_director_signed_at'),
