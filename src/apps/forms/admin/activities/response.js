...
const mapResources = (props, context) => ({
  actions: `/api/admin/forms/forms/${props.activity.data.form_id}/responses/${props.activity.data.response_id}/actions`,
  enrollment: `/api/admin/forms/forms/${props.activity.data.form_id}/responses/${props.activity.data.response_id}/enrollment`,
  ...
  workflow: `/api/admin/forms/forms/${props.activity.data.form_id}/workflow`
})
