const ItemFileName = {
  ...
  up: async (knex) => {
    ...
    await knex.raw(`
      ...
      select "code","item_id","team_id","type","folder_id","asset_id","owner_id","owned_by","label","file_name","fullpath","file_size","content_type","lock_expires_at","locked_by","deleted_at","created_at","updated_at"
      from (
      select
      0 as priority,
      "drive_folders"."code",
