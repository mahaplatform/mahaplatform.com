  ...
  render() {
    const products = [
      ...
      { id: 2, title: 'Tulip Paul Scherer', variants: [
        { fixed_price: 7.50, inventory_quantity: 5, media: [
      ...
      { id: 3, title: 'Tulip Princess Irenet', variants: [
        { fixed_price: 7.50, inventory_quantity: 7, media: [
      ...
      { id: 4, title: 'Tulip Purple Prince', variants: [
        { fixed_price: 7.50, inventory_quantity: 3, media: [
      ...
      { id: 5, title: 'Tulip Queen of Night', variants: [
        { fixed_price: 7.50, inventory_quantity: 9, media: [
      ...
      { id: 6, title: 'Tulipa Little Beauty', variants: [
        { fixed_price: 5.00, inventory_quantity: 7, media: [
      ...
      { id: 7, title: 'Narcissus Jetfire', variants: [
        { fixed_price: 8.75, inventory_quantity: 0, media: [
