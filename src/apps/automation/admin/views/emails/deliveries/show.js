...
const mapResourcesToPage = (props, context) => ({
  email: `/api/admin/automation/emails/${props.params.email_id}/deliveries/${props.params.id}`
})
    ...
    items: [
      {
        ...
        request: {
          method: 'PATCH',
          endpoint: `/api/admin/automation/emails/${props.params.email_id}/deliveries/${props.params.id}/resend`,
          onFailure: (result) => {
