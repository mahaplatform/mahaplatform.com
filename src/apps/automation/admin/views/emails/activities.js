...
const mapPropsToPage = (props, context, resources, page) => ({
  ...
  rights: [],
  collection: {
    endpoint: `/api/admin/automation/emails/${props.params.email_id}/activities`,
    table: [
    ...
    entity: 'email',
    onClick: (record) => context.router.history.push(`/crm/campaigns/email/${props.params.email_id}/deliveries/${record.email_id}`)
  }
})
