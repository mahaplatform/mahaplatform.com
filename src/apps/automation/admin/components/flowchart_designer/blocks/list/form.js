  ...
  _getForm() {
    ...
    return {
      ...
      sections: [
        {
          fields: [
            { label: 'Lists', type: 'segment', fields: [
              ...
              { name: 'list_id', type: 'lookup', required: true, prompt: 'Choose a list', endpoint: `/api/admin/crm/programs/${program.id}/lists`, value: 'id', text: 'title', form: this._getListForm(), defaultValue: config.list_id }
            ] }
          ]
        }
      ]
