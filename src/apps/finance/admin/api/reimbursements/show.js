...
const showRoute = async (req, res) => {
  ...
  const reimbursement = await Reimbursement.scope(qb => {
    ...
    withRelated: ['receipts.asset','receipts.asset.source','user','project.members','expense_type','line_items.project','line_items.expense_type','vendor','audit.story','audit.user.photo'],
    transacting: req.trx
  })
