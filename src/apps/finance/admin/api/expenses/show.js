...
const showRoute = async (req, res) => {
  ...
  const expense = await Expense.scope(qb => {
    ...
    withRelated: ['receipts.asset','receipts.asset.source','user','project.members','expense_type','line_items.project','line_items.expense_type','vendor','account','audit.story','audit.user.photo'],
    transacting: req.trx
  })
