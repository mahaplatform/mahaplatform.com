...
const mapPropsToPage = (props, context, resources, page) => ({
  ...
  rights: [],
  collection: {
    endpoint: `/api/admin/campaigns/voice/${props.params.campaign_id}/voicemails`,
    table: [
    ...
    entity: 'enrollment',
    onClick: (record) => context.router.history.push(`/campaigns/voice/${props.params.campaign_id}/voicemails/${record.id}`)
  }
})
