...
class Performance extends React.Component {
  ...
  _getCallsButton(label, query) {
    ...
    return {
      label,
      className: 'link',
      route: `/admin/campaigns/voice/${campaign.id}/calls${query}`
    }
  }
  ...
  _getVoicemailButton(label) {
    ...
    return {
      label,
      className: 'link',
      route: `/admin/campaigns/voice/${campaign.id}/voicemails`
    }
  }
  ...
  _getRecordingsButton(label) {
    ...
    return {
      label,
      className: 'link',
      route: `/admin/campaigns/voice/${campaign.id}/recordings`
    }
  }
