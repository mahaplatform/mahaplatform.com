...
const mapPropsToPage = (props, context, resources, page) => ({
  ...
  rights: [],
  collection: {
    endpoint: `/api/admin/campaigns/sms/${props.params.campaign_id}/sessions`,
    table: [
    ...
    entity: 'enrollment',
    onClick: (record) => context.router.history.push(`/campaigns/sms/${props.params.campaign_id}/sessions/${record.id}`),
    selectable: true,
    selectValue: 'id',
    recordTasks: (record) => [
      {
        ...
        request: {
          endpoint: `/api/admin/campaigns/sms/${props.params.campaign_id}/sessions/${record.id}`,
          method: 'DELETE',
    ...
    buttons: (selected, onSuccess) => [{
      ...
      request: {
        method: 'PATCH',
        endpoint: `/api/admin/campaigns/sms/${props.params.campaign_id}/sessions/delete`,
        body: {
