...
class Send extends React.Component {
  ...
  _getForm() {
    ...
    return {
      title: 'Send Campaign',
      method: 'patch',
      endpoint: `/api/admin/campaigns/sms/${campaign.id}/edit`,
      action: `/api/admin/campaigns/sms/${campaign.id}/send`,
      saveText: 'Send',
      ...
      sections: [
        {
          fields: [
            { label: 'To', name: 'to', type: ToField, program_id: campaign.program.id, channel: 'sms', required: true, purpose: campaign.purpose, defaultValue: campaign.to },
