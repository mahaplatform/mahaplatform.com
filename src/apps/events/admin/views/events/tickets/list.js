...
const mapPropsToPage = (props, context, resources, page) => ({
  ...
  collection: {
    ...
    table: [
      ...
      ...!_.includes(resources.event.ticket_config.hidden, 'gender') ? [{ label: 'Gender', key: 'values.gender', visible: false }] : [],
      ...!_.includes(resources.event.ticket_config.hidden, 'age') ? [{ label: 'Age', key: 'values.age', visible: false }] : [],
      ...!_.includes(resources.event.ticket_config.hidden, 'race') ? [{ label: 'Race', key: 'values.race', visible: false }] : [],
      ...!_.includes(resources.event.ticket_config.hidden, 'ethnicity') ? [{ label: 'Ethnicity', key: 'values.ethnicity', visible: false }] : [],
