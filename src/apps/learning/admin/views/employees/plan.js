    ...
    return [
      {
        ...
        text: 'Approve Plan',
        request: {
          endpoint: `/api/admin/learning/employees/${plan.employee_id}/plans/${plan.id}/approve`,
          method: 'patch'
        }
      }
    ]
    ...
    return [
      {
        ...
        text: 'Complete Plan',
        request: {
          endpoint: `/api/admin/learning/employees/${plan.employee_id}/plans/${plan.id}/complete`,
          method: 'patch'
        }
      }
    ]
      ...
      tasks: !goal.is_complete && plan.status === 'active' ? [
        {
          label: 'Complete Goal',
          request: {
            endpoint: `/api/admin/learning/employees/${plan.employee_id}/plans/${plan.id}/goals/${goal.id}/complete`,
            method: 'patch'
          }
        }
      ] : null
      ...
      tasks: !commitment.is_complete && plan.status === 'active' ? [
        {
          ...
          request: {
            endpoint: `/api/admin/learning/employees/${plan.employee_id}/plans/${plan.id}/commitments/${commitment.id}/complete`,
            method: 'patch'
          }
        }
      ] : null
...
const mapResourcesToPage = (props, context) => ({
  plan: `/api/admin/learning/employees/${props.params.employee_id}/plans/${props.params.id}`,
  goals: `/api/admin/learning/employees/${props.params.employee_id}/plans/${props.params.id}/goals`,
  commitments: `/api/admin/learning/employees/${props.params.employee_id}/plans/${props.params.id}/commitments`
})
