...
class PlanCommitment extends React.Component {
  ...
  _getAssignment() {
    ...
    return {
      action: `/api/admin/learning/plans/${plan.id}/commitments`,
      assignedEndpoint: `/api/admin/learning/plans/${plan.id}/commitments`,
      ...
      label: 'resource',
      unassignedEndpoint: `/api/admin/learning/plans/${plan.id}/commitments/all`,
      text: 'title',
