...
(function () {
  ...
  reactHotLoader.register(assetsFixtures, 'assetsFixtures', 'src/db/seeds/assets.js');
  reactHotLoader.register(_default, 'default', 'src/db/seeds/assets.js');
  leaveModule(module);
})();
