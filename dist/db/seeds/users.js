...
(function () {
  ...
  reactHotLoader.register(usersFixtures, 'usersFixtures', 'src/db/seeds/users.js');
  reactHotLoader.register(_default, 'default', 'src/db/seeds/users.js');
  leaveModule(module);
})();
